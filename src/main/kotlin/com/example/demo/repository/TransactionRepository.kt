...
public interface TransactionRepository : JpaRepository<Transaction,Long>{
    ...
    @Query(value="select date_part('year',datetime) as year,date_part('month',datetime) as month,date_part('day',datetime) as day ,date_part('hour',datetime) as hour , sum(amount) as amount " +
            " from Transaction t " +
